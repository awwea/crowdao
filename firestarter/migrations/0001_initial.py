# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-07-07 12:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orig', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='firestarter.Question', verbose_name=b'In reply to')),
            ],
        ),
        migrations.CreateModel(
            name='Reward',
        ...
        migrations.AddField(
            model_name='order',
            name='reward',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='firestarter.Reward', verbose_name=b'Reward Level'),
        ),
    ]
